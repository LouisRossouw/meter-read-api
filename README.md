...
### An API that captures an image from an ESP32-CAM electricity meter (No smart meter here fam) and uses Gemini to read and return the current meter value as a JSON obj.
